...
import it.prometeo.HL7Palm.SegmentFactory.SegmentFactoryORLO22;
...
public class ORLO22 {
    ...
    public ORL_O22 generateORL_O22FromORLPS(ORL_O22 orlFromTD) throws HL7Exception, IOException {

        MSH mshSegmentIntegrate = orl.getMSH();
        SegmentFactoryORLO22.createMSHSegmentIntegrateORLO22FromORLPS(mshSegmentIntegrate, orlFromTD);
    ...
    public ORL_O22 generateORL_O22FromORLTransfusion(ORL_O22 orlFromTD) throws HL7Exception, IOException {

        MSH mshSegmentIntegrate = orl.getMSH();
        SegmentFactoryORLO22.createMSHSegmentIntegrateORLO22FromORLTransfusion(mshSegmentIntegrate, orlFromTD);
