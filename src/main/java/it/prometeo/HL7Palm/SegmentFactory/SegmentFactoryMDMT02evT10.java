...
@Component
public class SegmentFactoryMDMT02evT10 {

    private static HL7Config hl7Config = null;

    @Autowired
    public SegmentFactoryMDMT02evT10(HL7Config hl7Config) {
        SegmentFactoryMDMT02evT10.hl7Config = hl7Config;
    }
    ...
    public static void createMSHSegmentIntegrateMDMT02evT02(MSH mshSegmentIntegrate, OML_O21 omlO21) throws DataTypeException {
        ...
        mshSegmentIntegrate.getMessageType().getTriggerEvent().setValue(hl7Config.getTriggerEventT10());
        mshSegmentIntegrate.getMessageType().getMessageStructure().setValue(hl7Config.getMessageStructureMDMT02evT10());
    ...
    public static void createEVNSegmentIntegrateMDMT02evT10(EVN evnSegmentIntegrate) throws DataTypeException {
    ...
    public static void createPIDSegmentIntegrateMDMT02evT10(PID pidSegmentIntegrate, OML_O21 omlMessage) throws HL7Exception {
    ...
    public static void createPV1SegmentIntegrateMDMT02evT10(PV1 pv1SegmentIntegrate, OML_O21 omlO21) throws DataTypeException {
    ...
    public static void createORCSegmentIntegrateMDMT02evT10(ORC orcSegmentIntegrate, OML_O21 omlMessage, int index) throws HL7Exception {
    ...
    public static void createOBRSegmentIntegrateMDMT02evT10(OBR obrSegmentIntegrate, OML_O21 omlMessage, int index) throws HL7Exception {
    ...
    public static void createTXASegmentIntegrateMDMT02evT10(TXA txaSegmentIntegrate, OML_O21 omlO21, WXSDOCUMENT entity) throws HL7Exception {
        ...
        //Scriverlo diverso quando capiamo come vengono salvati e come vengono gestiti lato TD
        txaSegmentIntegrate.getParentDocumentNumber().getEntityIdentifier().setValue(entity.getREFID());
    ...
    public static void createOBXSegmentIntegrateMDMT02ev10(OBX obxSegmentIntegrate, OML_O21 omlO21, WXSDOCUMENT entity) throws HL7Exception, SQLException, IOException {
