package it.prometeo.ServiceMDMT02evT10.Segment;
...
@Service
public class MessageSegmentServiceMDMT02evT10 {

    private static HL7Config hl7Config = null;

    @Autowired
    public MessageSegmentServiceMDMT02evT10(HL7Config hl7Config) {
        MessageSegmentServiceMDMT02evT10.hl7Config = hl7Config;
    }
    @Autowired
    ...
    public void saveMSHMessageSegmentMDMT02evT10(MDM_T02 mdmT02, MessageEvent messageEvent) throws HL7Exception {
    ...
    public void saveEVNMessageSegmentMDMT02evT10(MDM_T02 mdmT02, MessageEvent messageEvent) throws HL7Exception {
        Optional<MessageEvent> messageEventOptional = messageEventRepository.findById(messageEvent.getId());
        MessageSegment messageSegment = new MessageSegment();
        if(messageEventOptional.isPresent()) {
            Parser parser = new PipeParser();
    ...
    public void savePIDMessageSegmentMDMT02evT10(MDM_T02 mdmT02, MessageEvent messageEvent) throws HL7Exception {
        Optional<MessageEvent> messageEventOptional = messageEventRepository.findById(messageEvent.getId());
        MessageSegment messageSegment = new MessageSegment();
        if(messageEventOptional.isPresent()) {
            Parser parser = new PipeParser();
    ...
    public void savePV1MessageSegmentMDMT02evT10(MDM_T02 mdmT02, MessageEvent messageEvent) throws HL7Exception {
        Optional<MessageEvent> messageEventOptional = messageEventRepository.findById(messageEvent.getId());
        MessageSegment messageSegment = new MessageSegment();
        if(messageEventOptional.isPresent()) {
            Parser parser = new PipeParser();
    ...
    public void saveORDERBLOCKMessageMDMT02evT10(MDM_T02 mdmT02, MessageEvent messageEvent) throws HL7Exception {
        Optional<MessageEvent> messageEventOptional = messageEventRepository.findById(messageEvent.getId());
